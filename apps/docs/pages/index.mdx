...
| project        | description                                                                   |
| :------------- | :---------------------------------------------------------------------------- |
| [docs]         | the next framework has been configured to render .mdx files [more...][how-to] |
| [rtl-ninja]    | testing a simple todo app which utilizes a todo api                           |
| [rtl-taskhero] | testing a simple todo app which utilizes a todo api                           |
...
- perform task on individual workspace `yarn workspace rtl-ninja start`
